...
import { PodsViewComponent } from "../Pods/PodsViewComponent";
...
export class KubeSummary extends BaseComponent<IKubeSummaryProps, IKubernetesContainerState> {
    ...
    private _getFilterBar(): JSX.Element {
        if (this.state.selectedPivotKey === workloadsPivotItemKey) {
            return (<KubeFilterBar filter={this.state.workloadsFilter}
            ...
            return (<KubeFilterBar filter={this.state.svcFilter}
    ...
    private _getServiceDetailsView(serviceItem: IServiceItem): JSX.Element {
        ...
        return <ServiceDetailsView service={this.state.selectedItem} podListingPromise={podsListing} />;
    }
    ...
    private _setSelectedKeyPodsViewMap() {
        ...
        this._selectedItemViewMap[SelectedItemKeys.ServiceItemKey] = (item) => this._getServiceDetailsView(item);
